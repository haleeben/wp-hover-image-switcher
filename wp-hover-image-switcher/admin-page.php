...
<div class="wrap">
	<div id="admin-page" style="font-size:130%;">
    <div class="icon32" id="icon-themes">
        <br> 
    </div>
    <h2>Hover Image Switcher</h2>
    <h4>Instructions</h4>
    <ol>
    <li><p>After installing and activating the Hover Image Switcher Plugin all you need to do is go to your post/page editor and look for the Hover Image Switcher button.</p></li>
  	...
  	<li><strong> IMPORTANT: Both images must have the same name except that the hover image must end with -hover.</strong>
  		<p>Example: <ul><li>image1.jpg</li>
  						<li>image1-hover.jpg</li>
  						<li>image2.jpg</li>
  						<li>image2-hover.jpg</li>
  					</ul>
  		</p>
  	</li>
  	</ol>
  	<h4>If you find this plugin useful please consider a donation</h4>
  	<p>
  		<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
		<input type="hidden" name="cmd" value="_s-xclick">
		<input type="hidden" name="hosted_button_id" value="45PCEBYUSHZ5Q">
